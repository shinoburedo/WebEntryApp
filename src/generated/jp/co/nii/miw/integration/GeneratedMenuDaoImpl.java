...
import jp.co.nii.miw.business.domain.GeneratedMenu;
import jp.co.nii.miw.business.domain.GeneratedMenuDao;

/**
 * 生成された メニュー DAO実装クラス<br>
 * table-design-ver 1
 * @author DB管理ツール
 */
abstract class GeneratedMenuDaoImpl extends AbstractDao implements GeneratedMenuDao {

    /**
     * テーブルカラム名のカンマ区切り文字列。<br>
     * SQL文の作成に用いる。
     */
    protected static final String FIELDS = "MENU_CODE"
            + ",MENU_NAME"
            + ",RONRI_SAKUJO_FLG"
            + ",SHORI_KBN"
            + ",TOROKU_DATE"
     ...
     */
    protected static final String FIELDS_DECRYPT = "MENU_CODE"
            + "," + "MENU_NAME"
            + "," + "RONRI_SAKUJO_FLG"
            + "," + "SHORI_KBN"
            + "," + "TOROKU_DATE"
     ...
     */
    public GeneratedMenuDaoImpl(String datasource) {
        super(datasource);
    }

    /* (non-Javadoc)
     * @see jp.co.nii.miw.business.domain.GeneratedMenuDao#create(jp.co.nii.miw.business.domain.GeneratedMenu)
     */
    @Override
    public void create(GeneratedMenu bo) {
        Connection con = null;
        ...
        try {
            ...
            stmt.setString(i++, bo.getMenuName());
    ...
    /* (non-Javadoc)
     * @see jp.co.nii.miw.business.domain.GeneratedMenuDao#find(jp.co.nii.miw.business.domain.GeneratedMenu, java.lang.String)
     */
    @Override
    public GeneratedMenu find(GeneratedMenu bo, String lockMode) {
        Connection con = null;
        PreparedStatement stmt = null;
        ResultSet rs =null;
        String sql = "";
    ...
    /* (non-Javadoc)
     * @see jp.co.nii.miw.business.domain.GeneratedMenuDao#update(jp.co.nii.miw.business.domain.GeneratedMenu)
     */
    @Override
    public void update(GeneratedMenu bo) {
        Connection con = null;
        PreparedStatement stmt = null;
        String sql = "";
        try {
    ...
    /* (non-Javadoc)
     * @see jp.co.nii.miw.business.domain.GeneratedMenuDao#remove(jp.co.nii.miw.business.domain.GeneratedMenu)
     */
    @Override
    public void remove(GeneratedMenu bo) {
        Connection con = null;
        PreparedStatement stmt = null;
        String sql = "";
        try {
     ...
     */
    protected void setBoFromResultSet(GeneratedMenu bo, ResultSet rs) {
        try {
            bo.setMenuCode(rs.getString("MENU_CODE"));
            bo.setMenuName(rs.getString("MENU_NAME"));
