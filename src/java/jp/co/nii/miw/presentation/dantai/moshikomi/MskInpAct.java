...
//                mskTorokuJoho.setGazoId(gazoId);
    ...
    private boolean ValidationCaller(HttpServletRequest request, MskToroku mskTorokuJoho) throws Exception {
        ...
        if (errors.isEmpty()) {
            ...
            if (retMoshikomisha != null) {
                errors.add("double", new ActionMessage("errors.dntmskdouble", mskTorokuJoho.getShimeiSei() + " " + mskTorokuJoho.getShimeiMei()));
            }
        }
        //エラーをセッションBeanに格納
    ...
    public void deleteSpace(MskToroku mskToroku) {
        ...
        mskToroku.setJusho1(StringUtility.removeEdgeSpace(mskToroku.getJusho1()));
        mskToroku.setJusho2(StringUtility.removeEdgeSpace(mskToroku.getJusho2()));
        mskToroku.setJusho3(StringUtility.removeEdgeSpace(mskToroku.getJusho3()));
        mskToroku.setJusho4(StringUtility.removeEdgeSpace(mskToroku.getJusho4()));
        ...
        mskToroku.setExtNo(StringUtility.removeSpace(mskToroku.getExtNo()));
        ...
        mskToroku.setPasswdKakunin(StringUtility.removeSpace(mskToroku.getPasswdKakunin()));
