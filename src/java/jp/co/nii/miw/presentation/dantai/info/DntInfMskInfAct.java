...
/**
 * タイトル:DntInfMskInfAct
 * 説明:DntInfMskInfActのアクションクラス
 * 著作権:   Copyright (c) 2012
 * 会社名:   日本情報産業株式会社
 * @author --r.ehara
 */
public class DntInfMskInfAct extends AbstractAction {
    ...
    protected String doProcess(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        if (request.getParameter("submit") != null) {
            ...
            if (MiwConstants.FLG_OFF.equals(dntInfMenu.getDntResUpdKigenFlg())) {
                //申込情報変更可能期間ではない
