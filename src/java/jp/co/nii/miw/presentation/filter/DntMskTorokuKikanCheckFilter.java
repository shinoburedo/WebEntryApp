 ...
 * @author r.ehara
 */
public class DntMskTorokuKikanCheckFilter implements Filter {
    ...
    public final void doFilter(final ServletRequest req,
        ...
        try {
            ...
            if (MiwConstants.FLG_OFF.equals(dntMenu.getMskKigenFlg())) {

                //団体申込登録期間内ではない
                LogGenerate.errorOutput(
                        this.getClass().getName() + "　団体申込登録期間内ではありません", "none");
