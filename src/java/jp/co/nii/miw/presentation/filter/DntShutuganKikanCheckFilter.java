 ...
 * @author r.ehara
 */
public class DntShutuganKikanCheckFilter implements Filter {
    ...
    public final void doFilter(final ServletRequest req,
        ...
        try {
            ...
            if (MiwConstants.FLG_OFF.equals(dntMenu.getDntGetKigenFlg())) {
                //団体出願期間ではない
                LogGenerate.errorOutput(
                        this.getClass().getName() + "　団体出願期間内ではありません", "none");
