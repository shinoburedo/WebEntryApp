 ...
 * @author r.ehara
 */
public class DntMskUpdKikanCheckFilter implements Filter {
    ...
    public final void doFilter(final ServletRequest req,
        ...
        try {
            ...
            //団体申込情報変更期間ではない
            if (MiwConstants.FLG_OFF.equals(dntInf.getDntResUpdKigenFlg())) {
                LogGenerate.errorOutput(
                        this.getClass().getName() + "　団体申込情報変更期間内ではありません", "none");
