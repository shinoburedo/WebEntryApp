 ...
 * @author --k.narita
 */
public class MskPayCvsConfAct extends AbstractAction {
...
//                            throw new Exception("ユーザＩＤ：" + mskTorokuJoho.getId() + "メール送信失敗");
                            ...
                            LogGenerate.errorOutput("!Attention!ユーザＩＤ： "
                                    ...
                                    + " 決済コンビニ種別：" + mskTorokuJoho.getKessaiConvenienceShubetsu()
                        ...
                        //エラーメッセージ作成
                        String kessaiError = mskTorokuServ.kessaiErrorHenkan(MiwConstants.KESSAI_HOHO_KBN_CVS, strRtn[3]);

                        errors.add("0", new ActionMessage(kessaiError));
                        saveErrors(request, errors);
                        
                        LogGenerate.infoOutput("コンビニ決済でDCからNGが返却。ユーザＩＤ： "
