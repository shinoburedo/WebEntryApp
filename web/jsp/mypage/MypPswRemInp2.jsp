...
<html:html>
    ...
    <body>
        <div id="container">
            <html:form action="/Myp/MypPswRemInp2Act" focus="passwdAnswer1" onsubmit="disableSubmit(this)">
                <!--heder-->
                ...
                <table class="tableMain" cellpadding="5" cellspacing="0" style="width: 500px;">
                    ...
                    <tr>
                        <th><bean:write name="Moshikomisha" property="passwdQuestionCodeDisp"/></th>
                        <td class="basic">
                            <html:text name="MypPswRemFrm" property="passwdAnswer1" size="60" maxlength="20" styleClass="ime_on" styleId="ans"/>
                        </td>
                    </tr>
                </table>
                <br>        
