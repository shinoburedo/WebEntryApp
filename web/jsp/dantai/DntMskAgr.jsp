...
<html:html>
    <head>
        ...
        <title><bean:message key="title.Dantai_MskAgr"/></title>
    ...
    <body>
        ...
        <div id="container">
            ...
            <table class="TDheader" cellpadding="0" cellspacing="0">
                <tr>
                    <td><img src="../../image/nv_re_dnt2.gif" alt="団体申込出願フロー"></td>
                </tr>
            </table>
            <br>
            <table class="title"  border="1" cellpadding="2" cellspacing="0">
                <tr>
                    ...
                    <td class="right">２．<bean:message key="title.Dantai_MskAgr"/></td>
                </tr>
            </table>
            <br>
            <br>
            ...
            <table class="table1" cellspacing="0" cellpadding="0">
                <tbody>
                    <tr>
                        <td class="TDcenter">
                            <form name="NullFrm" method="post" action="../Msk/DntMskAgrAct.do" onsubmit="disableSubmit(this)">
                                <input type="button" value="メインメニューに戻る" onblur="offenter()" onfocus="onenter()" onclick="location.href='../MenuDaihyoshaAct.do'" style="width:150px"/>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
