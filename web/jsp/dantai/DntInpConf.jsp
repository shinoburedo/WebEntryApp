...
<html:html>
    <head>
        ...
        <title><bean:message key="title.Dantai_Conf"/></title>
    ...
    <body onload="setScrollTop();">
        <div id="container">
            <html:form action="/dantai/Msk/DntInpConfAct.do" styleId="frm" onsubmit="disableSubmit(this)">
                ...
                <table class="header" cellpadding="0" cellspacing="0">
                    <tr>
                        <td>
                            <br/>
                            <img src="../../image/nv_dnt3.gif" alt="団体申込出願フロー">
                        </td>
                    </tr>
                </table>
                <br>
                <table class="title"  border="1" cellpadding="2" cellspacing="0">
                    <tr>
                        ...
                        <td class="right">３．<bean:message key="title.Dantai_Conf"/></td>
                    </tr>
                </table>
                <br>
