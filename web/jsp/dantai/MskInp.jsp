...
<html:html>
    <head>
        ...
        <title><bean:message key="title.DntMskInp"/></title>
    ...
    <body onload="setScrollTop();">
        <div id="container">
            <div align="center">
                <html:form action="/dantai/Msk/MskInpAct">
                    <html:hidden property="scrollTop" />
                    <!--heder-->
                    <div id="title_header"></div>
                    <table class="header" cellpadding="0" cellspacing="0">
                        <tr>
                            <td><img src="../../image/nv_dnt_msk3.gif" alt="試験申込フロー"></td>
                        </tr>
                    </table>
                    <br>
                    <table class="title"  border="1" cellpadding="2" cellspacing="0">
                        <tr>
                            ...
                            <td class="right">３．<bean:message key="title.DntMskInp"/></td>
                        </tr>
                    </table>
                    <br>
                    <table class="table1">
                        ...
                        <logic:messagesPresent message="true">
                            <tr>
                                <td>
                                    ...
                                    <html:messages id="msg" message="true" property="double">
                                        ！<bean:write name="msg" />
                                    </html:messages >
                                    </font>
                                    <hr>
                    ...
                    <table class="tableMain" cellpadding="5" cellspacing="0">
                        ...
                        <tr>
                            <th colspan="3">医療保険事務の受講経験<br>
                            <font class="txtAttention">（必須）</font></th>
                        ...
                        <tr>
                            <td colspan="2" class="<bean:write name="MskTorokuJoho" property="validateCss(25)"/>">
                                <html:password name="MskTorokuJoho" property="passwd" styleId="passwd" size="25" maxlength="8"/>
                                <input id="showcharacters" name="showcharacters" type="checkbox" /> 確認する<br>
                                例）AaBbCc12&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;! # $ % 等は使用できません。
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2" class="<bean:write name="MskTorokuJoho" property="validateCss(26)"/>">
                                確認のため再度入力してください。<br>
                                <div onpaste="return false">
                                    <html:password name="MskTorokuJoho" property="passwdKakunin" size="25" maxlength="8"/><br>
                                </div>
                            </td>
                        </tr>
                        <tr>
                    ...
                    <table  class="table1" cellspacing="0" cellpadding="0">
                        <tbody>
                            <tr>
                                <td class="TDright">
                                    <input type="button" value="メインメニューに戻る" class="buttonNext" onblur="offenter()" onfocus="onenter()" onclick="backMenuConfirmFirstDantai('<bean:write name="menuUrl"/>')"/>
                                </td>
                            </tr>
                        </tbody>
                    </table>
