...
<html:html>
    <head>
        ...
        <title><bean:message key="title.DntMskPicSel" /></title>
    ...
    <body class="body" onload="putMessage()">
        <div id="container">
            <html:form action="/dantai/Msk/MskPicSelAct" enctype="multipart/form-data"  onsubmit="disableSubmit(this)">
                <!--heder-->
                <div id="title_header"></div>
                <div align="center">
                    <table class="header" cellpadding="0" cellspacing="0">
                        <tr>
                            <td><img src="../../image/nv_dnt_msk4.gif" alt="試験申込フロー"></td>
                        </tr>
                    </table>
                    <br>
                    <table class="title"  border="1" cellpadding="2" cellspacing="0">
                        <tr>
                            ...
                            <td class="right">４．<bean:message key="title.DntMskPicSel" /></td>
                        </tr>
                    </table>
                                ...
                                <table  cellspacing="0" cellpadding="3">
                                    ...
                                    <tr>
                                        <td>
                                            <table cellspacing="0" cellpadding="1">
                                                <tr>
                                                    <td>１&nbsp;指定の規格の写真のご準備ができていない場合は、画像切取ツールを入手し、写真を加工してください。<br>
                                    ...
                                    <tr>
                                        <td>
                                            <table cellspacing="0" cellpadding="1">
                                                <tr>
                                                    <td>２&nbsp;顔写真ファイルが、次の画面(顔写真を確認する画面)において、下記の「受付できない顔写真ファイルの例」
