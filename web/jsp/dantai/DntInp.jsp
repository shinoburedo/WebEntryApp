...
<html:html>
    <head>
        ...
        <title><bean:message key="title.Dantai_Inp"/></title>
            ...
            $(document).ready(function(){ 
                $('#showcharacters').click(function() { //チェックボックスがクリックされたとき
                    if ($(this).attr('checked')) { //もし、チェック状態であれば
                        $('#dantaiPasswd').replaceWith(
                         '<input type="text" name="dantaiPasswd" id="dantaiPasswd" size="30" style="ime-mode:disabled" value="' + $('#dantaiPasswd').attr('value') + '" />');
                         //パスワードを表示
                    } else { //チェックがなければ
                        $('#dantaiPasswd').replaceWith(
                         '<input type="password" name="dantaiPasswd" id="dantaiPasswd" size="25" value="' + $('#dantaiPasswd').attr('value') + '" />');
                         //パスワードを隠す
                        }
                });
                $('#showcharacters2').click(function() { //チェックボックスがクリックされたとき
                    if ($(this).attr('checked')) { //もし、チェック状態であれば
                        $('#dantaiMoshikomiPasswd').replaceWith(
                         '<input type="text" name="dantaiMoshikomiPasswd" id="dantaiMoshikomiPasswd" size="30" value="' + $('#dantaiMoshikomiPasswd').attr('value') + '" />');
                         //パスワードを表示
                    } else { //チェックがなければ
                        $('#dantaiMoshikomiPasswd').replaceWith(
    ...
    <body onload="setScrollTop();">
        <div id="container">
            <html:form action="/dantai/Msk/DntInpAct.do" styleId="frm" onsubmit="disableSubmit(this)">
                ...
                <table class="header" cellpadding="0" cellspacing="0">
                    <tr>
                        <td>
                            <br/>
                            <img src="../../image/nv_dnt2.gif" alt="団体申込出願フロー">
                        </td>
                    </tr>
                </table>
                <br>
                <table class="title"  border="1" cellpadding="2" cellspacing="0">
                    <tr>
                        ...
                        <td class="right">２．<bean:message key="title.Dantai_Inp"/></td>
                    </tr>
                </table>
                <br>
                ...
                <table class="tableMain"  cellpadding="5" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td colspan="2" class="<bean:write name="DntInfo" property="validateCss(4)"/>" >
                            <html:text name="DntInfo" property="jusho4" size="60" maxlength="25" style="ime-mode:active"/></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <th rowspan="3" colspan="3">
                            団体パスワード<br>
                            <font size="-2" class="blue">（団体代表者が使用するパスワードです。）</font><br>
                    ...
                    <tr>
                        <td class="<bean:write name="DntInfo" property="validateCss(14)"/>" colspan="2">
                            <html:password name="DntInfo" styleId="dantaiPasswd" property="dantaiPasswd" maxlength="8" size="25" />
                    ...
                    <tr>
                        <td class="<bean:write name="DntInfo" property="validateCss(15)"/>" colspan="2">
                            確認のため再度入力してください。<br>
                            <div onpaste="return false">
                                <html:password name="DntInfo" property="dantaiPasswdKakunin" maxlength="8" size="25" /><br>
                            </div>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="<bean:write name="DntInfo" property="validateCss(18)"/>" colspan="2">
                            ...
                            <input id="showcharacters2" name="showcharacters2" type="checkbox" /> 確認する
                            <br>
                            例）AaBbCc12&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;! # $ % 等は使用できません。
                        </td>
                    </tr>
                    <tr>
                        <td class="<bean:write name="DntInfo" property="validateCss(19)"/>" colspan="2">
                            確認のため再度入力してください。<br>
                            <div onpaste="return false">
