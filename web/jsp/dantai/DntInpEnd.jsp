...
<html:html>
    <head>
        ...
        <title><bean:message key="title.Dantai_End"/></title>
    ...
    <body>
        ...
        <div id="container">
            ...
            <table class="TDheader" cellpadding="0" cellspacing="0">
                <tr>
                    <td><img src="../../image/nv_dnt4.gif" alt="団体申込出願フロー"></td>
                </tr>
            </table>
            <br>
            <table class="title"  border="1" cellpadding="2" cellspacing="0">
                <tr>
                    ...
                    <td class="right">４．<bean:message key="title.Dantai_End"/></td>
                </tr>
            </table>
            <br>
            <br>
            <table class="table1" cellpadding="0" cellspacing="0">
                <tr>
                    <td>
                        認定試験 団体申込出願手続きをしていただき誠にありがとうございます。<br/>
                        <br/>
                        団体申込出願が完了しましたので、登録されたメールアドレスに団体コード通知メールを送信しました。<br/>
                        通知メールにはインターネット申込に必要な「団体コード」と「団体申込者登録用ID」が記載されています。<br/><br/>
                        <b>「団体コード」</b>と<b>「団体パスワード」</b>は、団体代表者が団体登録情報の確認・変更をする際、ログインするために使用します。<br>
                        ...
                        その際、<u><b>「団体コード」</b>と<b>「団体パスワード」</b>は団体代表者用の情報となりますので、各受験者に通知しないようにご注意ください。</u><br>
                <br>
                団体コード通知メールの再送信や、メール・お電話等による団体コードの照会は承っておりませんので、団体コード情報等は必ず保存や記録を行ってください。<br/>
