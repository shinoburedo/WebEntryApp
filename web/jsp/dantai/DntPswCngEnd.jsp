...
<html:html>
    <head>
        ...
        <title><bean:message key="title.DntPswCngEnd" /></title>
        ...
        <div id="container">
            ...
            <table class="title"  border="1" cellpadding="2" cellspacing="0">
                <tr>
                    ...
                    <td class="right"><bean:message key="title.DntPswCngEnd" /></td>
                </tr>
            </table>
            <br>
            <table class="tableNoFrame" cellpadding="40">
                <tr>
                    <td class="TDcenter TDmiddle"><font size="3"><b>団体パスワードを変更しました。</b></font></td>
                </tr>
            </table>
            <br>        
        </div>
