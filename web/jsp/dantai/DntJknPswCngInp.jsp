...
<html:html>
    <head>
        ...
        <title><bean:message key="title.DntJknPswCngInp" /></title>
    ...
    <body>
        <div id="container">
            <html:form action="/dantai/Inf/DntJknPswCngInpAct" onsubmit="disableSubmit(this)">
                <!--heder-->
                ...
                <table class="title"  border="1" cellpadding="2" cellspacing="0">
                    <tr>
                        ...
                        <td class="right"><bean:message key="title.DntJknPswCngInp" /></td>
                    </tr>
                </table>
                <br>
                    ...
                    <tr>
                        ...
                        <td class="basic">
                            <table cellspacing="0" cellpadding="1" width="99%">
                                <tr>
                                    <td class="TDmiddle">
                                        <html:password name="DntPswCngFrm" styleId="passwordNew1" property="passwordNew1" size="20" maxlength="8" styleClass="ime_off"/>
