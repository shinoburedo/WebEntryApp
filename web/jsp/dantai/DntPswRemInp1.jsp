...
<html:html>
    ...
    <body>
        <div id="container">
            <html:form action="/dantai/Inf/DntPswRemInp1Act" focus="dantaiCode" onsubmit="disableSubmit(this)">
                <!--heder-->
                ...
                <table class="tableNoFrame" cellpadding="4" cellspacing="0">
                    ...
                    <tr>
                        <td>
                            団体コード通知メールに記載されている団体コードと、申込時に登録した担当者カナ氏名を入力してください。
                        </td>
                    </tr>
                ...
                <table class="tableMain" cellpadding="5" cellspacing="0">
                    ...
                    <tr>
                        <th>団体コード</th>
                        <td class="basic">
                            <html:text name="DntPswRemFrm" property="dantaiCode" size="20" maxlength="5" styleClass="ime_off"/>
                        </td>
                    </tr>
                    <tr>
                        <th>担当者カナ氏名</th>
                        <td class="basic">
                            姓<html:text name="DntPswRemFrm" property="dantaiJimuTantoshaShimeiSeiKana" size="30" maxlength="50" styleClass="ime_on" styleId="knSei"/>&nbsp;&nbsp;
                            名<html:text name="DntPswRemFrm" property="dantaiJimuTantoshaShimeiMeiKana" size="30" maxlength="50" styleClass="ime_on" styleId="knMei"/>　
                        </td>
                    </tr>
                </table>
                <br>        
