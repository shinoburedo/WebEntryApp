...
<html:html>
    <head>
        ...
        <title><bean:message key="title.Dantai_MskLogin"/></title>
    ...
    <body>
        ...
        <div id="container">
            <html:form action="/dantai/Msk/DntMskLoginAct" focus="dantaiCode" onsubmit="disableSubmit(this)">
            <!--heder-->
            <div id="title_header"></div>
            <br>
            <table class="TDheader" cellpadding="0" cellspacing="0">
                <tr>
                    <td><img src="../../image/nv_re_dnt1.gif" alt="団体申込出願フロー"></td>
                </tr>
            </table>
            <br>
            <table class="title"  border="1" cellpadding="2" cellspacing="0">
                <tr>
                    ...
                    <td class="right">１．<bean:message key="title.Dantai_MskLogin"/></td>
                </tr>
            </table>
            <br>
            <br>
                    ...
                    <tr>
                        <td>
                           &nbsp;&nbsp;団体コード通知メールに記載されている「団体コード」及び、<br/>
                            ...
                            <br/>
                            &nbsp;&nbsp;団体コードの取得がお済みでない方は<a href="./DntTopAct.do">こちら</a><br/>
