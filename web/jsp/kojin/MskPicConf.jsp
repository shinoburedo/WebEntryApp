...
<html:html>
    <head>
        ...
        <title><bean:message key="title.MskPicConf" /></title>
    ...
    <body class="body">
        <div id="container">
            <html:form action="/kojin/Msk/MskPicConfAct" enctype="multipart/form-data"  onsubmit="disableSubmit(this)">
                <!--heder-->
                <div id="title_header"></div>
                <div align="center">
                    <table class="header" cellpadding="0" cellspacing="0">
                        <tr>
                            <td><img src="../../image/nv_msk_k6.gif" alt="試験申込フロー"></td>
                        </tr>
                    </table>
                    <table class="title"  border="1" cellpadding="2" cellspacing="0">
                        <tr>
                            <td class="left" cellpadding="0"></td>
                            <td class="right">６．顔写真確認</td>
                        </tr>
                    </table>
                    ...
                    <table class="table1" cellspacing="0" cellpadding="0">
                        <tr>
                            <td class="td1">
                                <font class="font12b">　顔写真が正しく表示されていることを確認し、｢次へ」ボタンを押してください。<br>
                                　顔写真が正しく表示されていない場合は、「戻る」ボタンを押して前画面に戻り、再度顔写真ファイルを選択し直してください。</font><br>
                            </td>
                        </tr>
                    </table>
                    <br>
