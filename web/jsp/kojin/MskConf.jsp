...
<html:html>
    <head>
        ...
        <title><bean:message key="title.MskConf" /></title>
    ...
    <body>
        <div id="container">
            <html:form action="/kojin/Msk/MskConfAct"  onsubmit="disableSubmit(this)">
                <!--heder-->
                <div id="title_header"></div>
                <div align="center">
                    <table class="header" cellpadding="0" cellspacing="0">
                        <tr>
                            <td><img src="../../image/nv_msk_k4.gif" alt="試験申込フロー"></td>
                        </tr>
                    </table>
                    <table class="title"  border="1" cellpadding="2" cellspacing="0">
                        <tr>
                            <td class="left" cellpadding="0"></td>
                            <td class="right">４．申込情報確認</td>
                        </tr>
                    </table>
                    <br>
                    <table class="table1" cellpadding="4" cellspacing="0">
                        <tr>
                            <td>
                                以下の入力内容を確認し、誤りがない場合は「次へ」ボタンを押してください。<br>
                                誤りがある場合は、「入力内容の修正」ボタンを押し、正しい情報を入力し直してください。
                            </td>
                        </tr>
                    </table>
                    ...
                    <table class="table1" cellspacing="0" cellpadding="0">
                        <tr>
                            <td class="TDcenter">
                                <html:submit property="back" value="入力内容の修正"style="width:120px" onblur="offenter()" onfocus="onenter()" onclick="setHiddenValue(this)"/>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <html:submit property="submit" value="次　へ" style="width:120px" onblur="offenter()" onfocus="onenter()" onclick="setHiddenValue(this)"/>
                            </td>
                        </tr>
                    </table>
                    <table  class="table1" cellspacing="0" cellpadding="0">
