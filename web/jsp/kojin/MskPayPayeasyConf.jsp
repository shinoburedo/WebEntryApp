...
<html:html>
    ...
    <body>
        <div id="container">
            <div align="center">
                <html:form action="/kojin/Msk/MskPayPayeasyConfAct" onsubmit="disableSubmit(this)">
                    <!--heder-->
                    ...
                    <table class="table1" cellpadding="4" cellspacing="0">
                        <tr>
                            <td>
                                ...
                                決済方法を変更する場合は「戻る」ボタンを押し、前画面で再選択してください。<br/>
                            </td>
                        </tr>
                    </table>
                    <br/>
                    <table class="table1" cellpadding="4">
                        ...
                        <tr>
                            ...
                            <td>いったん納入された<%=MiwConstants.JUKEN_CHARGE_NAME%>は、理由の如何にかかわらず返金いたしません。</b></td>
                        </tr>
