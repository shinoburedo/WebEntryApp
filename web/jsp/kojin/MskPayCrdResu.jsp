...
<html:html>
    <head>
        ...
        <title><bean:message key="title.MskPayResu" /></title>
                ...
                <table class="table1" cellpadding="1" cellspacing="0">
                    <tr>
                        <td class="TDcenter" style="line-height: 190%;">
                            <br>
                            <font size="+1"><b>インターネットによる申込手続きが完了しました。</b></font><br>
                            <b>ご登録いただいたメールアドレス宛に申込完了の確認メールを送信しました。<br>
                                </td>
                                </tr>
                                </table>
                                <br>
                                <table class="table1" cellpadding="1" cellspacing="0">
                                    ...
                                    <tr>
                                        <td class="TDcenter">
                                            <b><font size="+1">この画面の内容を<font class="txtAttention">必ず保存又は印刷<b></font>し、<br>
                                                    受験票が届くまで大切に保管してください。</font><br/>
                                                    </td>
                                                    </tr>
                                                    <tr>
                                                        <td><hr></td>
                                                    ...
                                                    <table class="table1" cellpadding="4">
                                                        <tr>
                                                            ...
                                                            <td width="97%">診療報酬請求事務能力認定試験インターネット申込メインメニューの「申込内容確認」より、<bean:write name="MskTorokuJoho" property="mypageKigenDisp" />まで、申込内容の確認及び受験希望地等の変更が可能です。確認・変更にはＩＤとパスワードが必要です。</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="TDtop TDcenter"><b>２</b></td>
                                                            <td>確認メールが届かない場合は、入力されたメールアドレスの誤りや受信制限等が考えられます。申込内容確認の「申込内容の確認・変更」から、メールアドレスをご確認いただき、誤りがある場合はメールアドレスを訂正してください。訂正後にメールは届きませんが、「申込内容の確認・変更」画面に「受付完了」が表示されていれば申込は無事に完了しています。</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="TDtop TDcenter"><b>３</b></td>
                                                            <td>
                                                                クレジットカード会社が発行するご利用明細書は、控えとして大切に保管してください。
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    <br>
