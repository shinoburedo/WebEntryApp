...
<html:html>
    <head>
        ...
        <title><bean:message key="title.Kojin_JznAgr"/></title>
        ...
        <div id="container">
            ...
            <table class="table1" cellpadding="0" cellspacing="0" >
                <tr>
                    <td rowspan="3"width="599" class="TDleft">
                        ...
                        　　　以下の注意事項をよくお読みの上、「ＩＤ取得を行う」をクリックしてください。
                        </font>
                    </td>
                </tr>
            </table>
                ...
                <tr>
                    <td>
                        <table cellpadding="1" cellspacing="0">
                            ...
                            <tr>
                                <td  class="TDleft" colspan="2">
                                    ・ ＩＤ取得にはメールアドレスが必要です。日本語のメールアドレスはシステム未対応のため登録できません。<br/>
                                </td>
                            </tr>
                            <tr>
                                <td  class="TDleft" colspan="2">
                            ...
                            <tr>
                                <td  class="TDleft" colspan="2">
                                   ・ ＩＤ及びパスワードの管理は申込者ご本人にお願いいたします。ＩＤ及びパスワードの漏えい、違法利用などから生じた損害に対して当協会は責任を負いかねます。<br/>
                                </td>
                            </tr>
                            <tr>
                                <td  class="TDleft" colspan="2">
            ...
            <table cellspacing="0" cellpadding="0">
                <tbody>
                    <tr>
                        <td class="TDcenter">
                            <html:form action="/kojin/Jzn/JznAgrAct" onsubmit="disableSubmit(this)">
                                <input type="button" value="メインメニューに戻る" onclick="location.href='../MenuAct.do'" style="width:150px"/>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <html:submit property="submit"value="ＩＤ取得を行う" onblur="offenter()" onfocus="onenter()"  onclick="setHiddenValue(this)" style="width:150px"/>
                            </html:form>
                        </td>
                    </tr>
                </tbody>
