            ...
            <div align="center">
                    ...
                    <tr>
                        <td class="TDcenter">
                            ...
                            <b>
                                ...
                                <br/>
                                お申込はまだ完了していません。<br/>
                                <logic:equal name="MskTorokuJoho" property="kessaiConvenienceShubetsu" value="02">
                                    払込票を印刷又は<bean:write name="MskTorokuJoho" property="kessaiConvenienceShubetsuNoName"/>をメモし、<bean:write name="MskTorokuJoho" property="kessaiKigenDisp" />までにコンビニで<br/>
                                    <%=MiwConstants.JUKEN_CHARGE_NAME%>をお支払ください。<br/> 
                                </logic:equal>
                                <logic:notEqual name="MskTorokuJoho" property="kessaiConvenienceShubetsu" value="02">
                                    <bean:write name="MskTorokuJoho" property="kessaiConvenienceShubetsuNoName"/>をメモし、<bean:write name="MskTorokuJoho" property="kessaiKigenDisp" />までにコンビニで<br/>
                                    <%=MiwConstants.JUKEN_CHARGE_NAME%>をお支払ください。<br/> 
                                </logic:notEqual>
                                </font>
                                <br/>
                ...
                <table class="table1" cellpadding="4">
                    <tr>
                        ...
                        <td colspan="2">
                            <%=MiwConstants.JUKEN_CHARGE_NAME%>は選択されたコンビニで必ず<bean:write name="MskTorokuJoho" property="kessaiKigenDisp" />までにお支払ください。<br/>
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            コンビニでお支払の際のレシートは、控えとして大切に保管してください。
                        </td>
                    </tr>
                    <tr>
                        <td class="TDtop TDcenter"><b>３</b></td>
                        <td colspan="2">
                            <b style="font-weight: 300;">コンビニでの入金が確認できるまで、申込完了のメールは送信されません。</b>
                        </td>
                    </tr>
                    <tr>
                        <td class="TDtop TDcenter"><b>４</b></td>
                        <td colspan="2">
                            コンビニでお支払を終えたにもかかわらず、申込完了のメールが届かない場合は、<br>
                        </td>
                    </tr>
                    <tr>
                        <td width="3%">　</td>
                ...
                <table class="tableMain" cellpadding="5" cellspacing="0">
                    ...
                    <tr>
                        <td colspan="1"><b>払込情報</b></td>
                    </tr>
                    <logic:equal name="MskTorokuJoho" property="kessaiConvenienceShubetsu" value="03" >
                        <tr>
                            <th> 第1番号（企業コード）
                            </th>
                            <td class="basic">
                    ...
                    <logic:notEqual name="MskTorokuJoho" property="kessaiConvenienceShubetsu" value="03" >
                        <tr>
                            <th> <bean:write name="MskTorokuJoho" property="kessaiConvenienceShubetsuNoName"/> </th>
                            <td class="basic" colspan="2">
                                <table width="99%" borderstyle="">
                                    <tr>
                                        <td width="50%">
                                            <bean:write name="MskTorokuJoho" property="kessaiUketsukeNo" />&nbsp;
                                        </td>
                                        <td width="48%">
                                            <div align="right">
                                                <button onclick="window.open('<bean:write name="MskTorokuJoho" property="kessaiConvenienceHaraikomihyoUrl"/>', '', 'width=800,height=700');">払込情報詳細</button>
                    ...
                    <tr>
                        <th> ご利用コンビニ </th>
                        <td class="basic" colspan="2"><bean:write name="MskTorokuJoho" property="kessaiConvenienceShubetsuDisp" /></td>
                    </tr>
                    <logic:equal name="MskTorokuJoho" property="kessaiConvenienceShubetsu" value="01" >
                        <tr>
                            <th> 電話番号 </th>
                            <td class="basic" colspan="2">
                                <bean:write name="MskTorokuJoho" property="kessaiTel" /><br/>
                                ※電話番号の入力を求められますので、この番号を入力してください。
                            </td>
                        </tr>
                    </logic:equal>
                    <tr>
                        <th> <%=MiwConstants.JUKEN_CHARGE_NAME%> </th>
                    ...
                    <tr>
                        <td class="TDcenter" colspan="3">
                            <logic:equal name="MskTorokuJoho" property="kessaiConvenienceShubetsu" value="02">
                                <b>払込票を印刷又は<bean:write name="MskTorokuJoho" property="kessaiConvenienceShubetsuNoName"/>をメモし、コンビニで<%=MiwConstants.JUKEN_CHARGE_NAME%>をお支払ください。</b><br/> 
                            </logic:equal>
                            <logic:notEqual name="MskTorokuJoho" property="kessaiConvenienceShubetsu" value="02">
                                <b><bean:write name="MskTorokuJoho" property="kessaiConvenienceShubetsuNoName"/>をメモし、コンビニで<%=MiwConstants.JUKEN_CHARGE_NAME%>をお支払ください。<br/> 
                                </logic:notEqual>
                        </td>
                    </tr>
                </table>
